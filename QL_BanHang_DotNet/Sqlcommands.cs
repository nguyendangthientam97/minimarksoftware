...
namespace QL_BanHang_DotNet
{
    class Sqlcommands
    {
        ...
        public Sqlcommands()
        {
            dataConnection.ConnectionString = @"Data Source=THIENTAM;Initial Catalog=QuanLiBanHang_DotNet;Integrated Security=True";
        ...
        /// </summary>
        /// <param name="sqlCommand">Câu lệnh SQL</param>
        public Boolean executeNonQuery(string sqlCommand, [Optional,DefaultParameterValue(false)]
        Boolean allowOpen)
        {
            if (this.open())
            {
